...
<?
   ...
   include("functions.php");
	   ...
	   {		
			updateDepartment($_POST["txtDeptID"],$_POST["txtName"],$_POST["txtDescription"]);
		  
	   }
	   else if($_POST['submit']=="ADD")  
	   {
		//echo " Press ADD ";
			addDepartment($_POST["txtName"],$_POST["txtDescription"]);
	...
	$strSQL  = " SELECT Department_ID as DEPT_ID ,Department_NAME as DEPT_NAME , DESCRIPTION as DEPT_DESCRIPTION  ";
	...
	$strSQL .=" order  by DEPT_ID  LIMIT $Page_Start , $Per_Page";
	...
	<table width="1000px" border="1">
	  <tr>
		<td colspan='4' align='center'><font size='5'><b>DEPARTMENT MANAGEMENT</b></font></td>	 
	  <tr>
	...
	?>
	  <tr>
		...
		<td align="center"><?=$objResult["DEPT_NAME"];?></td>
		<td align="center"><?=$objResult["DEPT_DESCRIPTION"];?></td>
		<td align="center"><a href="department.php?deptId=<?=$objResult["DEPT_ID"];?>">Edit</a></td>
	  </tr>
   ...
   <br><br><br>
    ...
    <?
		...
		//	$objResult = mysql_fetch_array($objQuery);
			...
			echo "<form action='department.php' method='post'>";
			...
			//echo "</table>";
			//$proId ="x";
			if (null!=isset($_GET["deptId"]))
			{

				$strSQL .= " WHERE  Department_ID = '".$_GET["deptId"]."'";
							mysql_query("SET NAMES UTF8");
				//echo "<br/>".$strSQL."<br/>";
				$objQuery = mysql_query($strSQL);
				$objResult = mysql_fetch_array($objQuery);
				...
				echo "<td align='left'><input name='txtName' type='text' size='50' maxlength='50' value='".$objResult['DEPT_NAME']." ' ></td></tr>";
			//	echo "</tr>";
				echo "<tr><td align='center'>DESCRIPTION</td>";
				echo "<td align='left'><TEXTAREA name='txtDescription' type='text' COLS='50' ROWS='2'>".$objResult['DEPT_DESCRIPTION']."</TEXTAREA></td>";
				echo "</tr>";
				echo "<tr><td colspan='2' ><input name='txtDeptID' type='hidden' value=' ".$objResult['DEPT_ID']."' ></td></tr> ";
