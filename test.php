...
/*
  ...
  <!-- form name="ReqFrm" method="post" action="userfunction.php"  onsubmit="return validateReqeust(this);" -->
   <form name="ReqFrm" id="RegFrm" method="post" action="test.php"  onsubmit="return validateReqeust(this);">
...
<!--form name="ReqFrm" method="post" action="regist.php"  onsubmit="return validateReqeust(this);"-->
	...
	?>
        ...
        <script>
			var dep =document.all.RegFrm["txtLocationID"];
			 var sdep =document.all.RegFrm["txtSubLocationId"];
			 var b=document.getElementsByName("txtDepartmentID");
			 document.write('txtLocationId   มีvalue = '+dep.value+"<br>");
			 document.write('txtSubLocationId   มีvalue = '+sdep.value+"<br>");
			 document.write('dept   มีvalue = '+b[0].value+"<br>");
		</script>
</body>
</html>
